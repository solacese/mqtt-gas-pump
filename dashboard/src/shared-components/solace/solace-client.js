...
export const SolaceClient = function (connectOptions, topicName, subscriberCallback) {
    var solaceclient = {};
    ...
    solaceclient.connect = function () {
        ...
        solaceclient.log('Connecting to Solace message router using url: ' + connectOptions.solace_ws_host);
        solaceclient.log('Client username: ' + connectOptions.username);
        solaceclient.log('Solace message router VPN name: ' + connectOptions.vpn);
        // create session
        try {
